...
def ExtractDataForEQ(one_Fund,Per,Exchng):
    ...
    #CCI
    EQ_Cls_Dt_ClsPrc=(historical_data['Close']+historical_data['High']+historical_data['Low']+historical_data['Open'])/4
    EQ_Cls_Dt_ClsPrc=EQ_Cls_Dt_ClsPrc.dropna()
    #RSI_DF=rsi_tradingview(historical_data)
