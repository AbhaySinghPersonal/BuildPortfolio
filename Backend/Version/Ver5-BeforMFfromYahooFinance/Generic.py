...
from MarketConfig import RSI_CAL_METHOD, METHOD_CCI, METHOD_SMA 
import csv 
import pandas as pd
import statistics
import datetime
...
def GetAnalyticalData(Price_Lst,Last_EMA_9,Last_EMA_12,Last_EMA_21,Last_EMA_26,Last_EMA_50,Last_EMA_100,Gain_Lst,Loss_Lst,PrcandMeanDiffSum,GainCCI,LossCCI,Is_First_Analysis=False,PrevSum_Of_Square_Of_Prc_Minus_Mean=0,Prev_Smoothed_Gain=0,Prev_Smoothed_Loss=0,Last_Signal_Line=0): 
    ...
    if(Price_Lst_Len>=2):
        ...
        Price_Lst_StdDev2=2*CurStdDev
        Price_Lst_StdDev3=3*CurStdDev
...
def CalBuySellRecommend(Prc,MeanPlusSTDev2,MeanMinusSTDev2,RSI,MACD_Minus_Signal_Line):
    if(RSI==0):
       ...
       if(RSI>STRONG_SHORT_VALUE):
           ...
           return SHORT
    elif((RSI<MeanMinusSTDev2) and (MACD_Minus_Signal_Line>0)):
      ...
      for Fund_Sch in Fund_Grp_Lst:
         try:
            ...
            for Fund_Row in Fund_Grp_Lst[Fund_Sch][0:]:
                  ...
                  Price_Lst_Mean,Price_Lst_StdDev2,Price_Lst_Mean_Plus_StdDev2,Price_Lst_Mean_Minus_StdDev2,Price_Lst_StdDev3,Price_Lst_Mean_Plus_StdDev3,Price_Lst_Mean_Minus_StdDev3,EMA_9,EMA_12,EMA_21,EMA_26,EMA_50,EMA_100,Smoothed_Gain,Smoothed_Loss,RSI,MACD,Sum_Of_Square_Of_Prc_Minus_Mean,PrcandMeanDiffSum,GainCCI,LossCCI,Signal_Line=GetAnalyticalData(Price_Lst,EMA_9,EMA_12,EMA_21,EMA_26,EMA_50,EMA_100,Gain_Lst,Loss_Lst,PrcandMeanDiffSum,GainCCI,LossCCI,Is_First_Analysis,Sum_Of_Square_Of_Prc_Minus_Mean,Smoothed_Gain,Smoothed_Loss,Signal_Line)
                  LST=[None,None,None,None,None,None,None,None,None,Price_Lst_GAIN,Price_Lst_LOSS,None,None,None,None,None,None,Smoothed_Gain,Smoothed_Loss,None,None,None]
...
def RetOneList(Fund_Ind_Row):
   ...
   FundRow['Price_Lst_StdDev3']=Fund_Ind_Row[10]
   FundRow['Price_Lst_Mean_Plus_StdDev3']=Fund_Ind_Row[11]
   FundRow['Price_Lst_Mean_Minus_StdDev3']=Fund_Ind_Row[12]
   FundRow['Sum_Of_Square_Of_Prc_Minus_Mean']=Fund_Ind_Row[13]
   FundRow['Price_Lst_GAIN']=Fund_Ind_Row[14]
   FundRow['Price_Lst_LOSS']=Fund_Ind_Row[15]
   FundRow['EMA_9']=Fund_Ind_Row[16]
   FundRow['EMA_12']=Fund_Ind_Row[17]
   FundRow['EMA_21']=Fund_Ind_Row[18]
   FundRow['EMA_26']=Fund_Ind_Row[19]
   FundRow['EMA_50']=Fund_Ind_Row[20]
   FundRow['EMA_100']=Fund_Ind_Row[21]
   FundRow['Smoothed_Gain']=Fund_Ind_Row[22]
   FundRow['Smoothed_Loss']=Fund_Ind_Row[23]
   FundRow['RSI']=Fund_Ind_Row[24]
   FundRow['MACD']=Fund_Ind_Row[25]
   FundRow['Signal_Line']=Fund_Ind_Row[26]
   ...
   try:
      ...
      if(DateTillNoCalFrmtd>=FundLaunchDate):
         if(DateTillNoCalFrmtd==FundLaunchDate):
            ...
            Is_First_Analysis=False
         Price_Lst,Last_EMA_9,Last_EMA_12,Last_EMA_21,Last_EMA_26,Last_EMA_50,Last_EMA_100,Gain_Lst,Loss_Lst,SecLast,Last_FundPrcDt,Sum_Of_Square_Of_Prc_Minus_Mean,Smoothed_Gain,Smoothed_Loss,Signal_Line=GDB.GetPrevAnalyticalData(DateTillNoCalFrmtd,ISIN)
         Lst=OneNAVRec[3]=float(OneNAVRec[3])
         Gain_Lst,Loss_Lst,Price_Lst_GAIN,Price_Lst_LOSS=UpdGainLossList(Lst,SecLast,Gain_Lst,Loss_Lst)
         if(Last_FundPrcDt!=Cur_Dt.strftime("%Y-%m-%d")):
            Price_Lst.append(Lst)
      
         Price_Lst_Mean,Price_Lst_StdDev2,Price_Lst_Mean_Plus_StdDev2,Price_Lst_Mean_Minus_StdDev2,Price_Lst_StdDev3,Price_Lst_Mean_Plus_StdDev3,Price_Lst_Mean_Minus_StdDev3,EMA_9,EMA_12,EMA_21,EMA_26,EMA_50,EMA_100,Smoothed_Gain,Smoothed_Loss,RSI,MACD,Sum_Of_Square_Of_Prc_Minus_Mean,PrcandMeanDiffSum,GainCCI,LossCCI,Signal_Line=GetAnalyticalData(Price_Lst,Last_EMA_9,Last_EMA_12,Last_EMA_21,Last_EMA_26,Last_EMA_50,Last_EMA_100,Gain_Lst,Loss_Lst,PrcandMeanDiffSum,GainCCI,LossCCI,Is_First_Analysis,Sum_Of_Square_Of_Prc_Minus_Mean,Smoothed_Gain,Smoothed_Loss,Signal_Line)
