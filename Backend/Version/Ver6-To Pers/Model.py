...
# Python 3.x
import urllib
params = urllib.parse.quote_plus("DRIVER={ODBC Driver 17 for SQL Server};SERVER="+server+";DATABASE="+dbname+";UID="+uname+";PWD="+pword+";Trusted_Connection=no;")
...
class FIAnalyticsData(db.Model):
    ...
    UpdDate=db.Column(db.DateTime,default=datetime.datetime.now())
    def __init__(self,ISIN,FundPrice,FundPriceAsOnDate,BuySellRecommend,Price_Lst_Mean,Price_Lst_StdDev2,Price_Lst_Mean_Plus_StdDev2,Price_Lst_Mean_Minus_StdDev2,Price_Lst_GAIN,Price_Lst_LOSS,EMA_9,EMA_12,EMA_21,EMA_26,EMA_50,EMA_100,RSI,CCI,MACD):
        self.ISIN=ISIN
...
class FIAnalyticsDataSchema(ma.Schema):
    class Meta:
        fields=('id','ISIN','FundPrice','FundPriceAsOnDate','BuySellRecommend','Price_Lst_Mean','Price_Lst_StdDev2','Price_Lst_Mean_Plus_StdDev2','Price_Lst_Mean_Minus_StdDev2','Price_Lst_GAIN','Price_Lst_LOSS','EMA_9','EMA_12','EMA_21','EMA_26','EMA_50','EMA_100','RSI','CCI','MACD','UpdDate')
