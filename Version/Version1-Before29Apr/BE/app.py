...
def Recommend_fund():
    ...
    message = {
        'PreviousBuySellRecommend': SHRT_LNG_MAPNG[previous_recommendation],
        'CurrentBuySellRecommend': SHRT_LNG_MAPNG[current_recommendation],
        'NextBuySellRecommend': SHRT_LNG_MAPNG[next_recommendation]
    }
